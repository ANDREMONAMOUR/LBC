...
COMPANY_SVI = os.environ.get("COMPANY_SVI", "04 78 12 34 56")
COMPANY_EMAIL = os.environ.get("COMPANY_EMAIL", "contact@lebonclic.fr")
COMPANY_ADDRESS = os.environ.get("COMPANY_ADDRESS", "Lyon, France")
